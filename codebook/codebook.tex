...
morekeywords={constexpr,ll,decltype},									% if you want to add more keywords to the set
breakautoindent=false,\t\t\t\t\t\t\t% disable automatic continuation indentation
postbreak=\mbox{\hspace{2em}},\t\t\t\t\t% indent wrapped lines after the break
keywordstyle=\color{Blue1},
morekeywords=[2]{istream,ostream,vector,string,pair,tuple,queue,deque,set,map,multiset,multimap,unordered_map,unordered_set,priority_queue,function,optional,variant,bitset,array,stack,complex,initializer_list},
keywordstyle=[2]\color{Green4},
commentstyle=\color{Red4},
stringstyle=\color{DarkOrange3},
}
