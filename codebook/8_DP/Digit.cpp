...
ll solve(string s) {
	...
	return [&](this auto &&self, int p, int eff, bool f0, bool lim) -> ll {
...
ll solve(int x, ll n) {
	...
	int len = a.size() - 1;
	return [&](this auto &&self, int p, bool f0, bool lim) -> ll {
...
ll solve(ll x) { // 建 a...
	return [&](this auto &&self, int p, int prv, bool f0, bool lim) -> ll {
