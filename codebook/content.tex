...
\subsection{Planet_Cycles} 
\lstinputlisting{Graph/Planet_Cycles.cpp}
\subsection{找環} 
...
\subsection{無權樹直徑} 
\lstinputlisting{Tree/Unweighted_Tree_Distances}
\subsection{有權樹直徑} 
\lstinputlisting{Tree/Weighted_Tree_Distances}