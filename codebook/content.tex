\section{Basic}
\inputcode{Basic}{1_Basic/install_vscode.cpp}
\inputcode{Basic}{1_Basic/basic.cpp}
\inputcode{Basic}{1_Basic/cmp.cpp}
\inputcode{Basic}{1_Basic/pbds.cpp}

\section{Graph}
\inputcode{DFS 跟 BFS}{2_Graph/DFS_BFS.cpp}
\inputcode{DSU}{2_Graph/DSU.cpp}
\inputcode{最短距離算法 - Dijkstra}{2_Graph/Dijkstra.cpp}
\inputcode{最小生成樹 - Prim}{2_Graph/Prim.cpp}
\inputcode{正權找環}{2_Graph/PosCycle_Finding.cpp}
\inputcode{負權找負環}{2_Graph/NegCyc_Using_BellmanFord.cpp}
\inputcode{正權最大距離}{2_Graph/MaxDistance.cpp}
\inputcode{負權最大距離}{2_Graph/NegWeights_Max_Distance.cpp}
\inputcode{FloydWarshall}{2_Graph/FloydWarshall.cpp}
\inputcode{歐拉環與歐拉路}{2_Graph/EulerRoad.cpp}
\inputcode{SCC 結合拓樸 DP}{2_Graph/SCC_Topo_DP.cpp}
...
\inputcode{Concert Ticket}{7_Search and Gready/Concert_Ticket.cpp}
\inputcode{Restaurant Customers}{7_Search and Gready/Restaurant_Customers.cpp}
...
\inputcode{Max_overlap}{9_DP/Max_overlap.cpp}
